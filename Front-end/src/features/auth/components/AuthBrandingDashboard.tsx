...
export function AuthBrandingDashboard() {
  return (
    <aside className="hidden lg:flex lg:flex-col lg:w-[480px] xl:w-[520px]
                      ...
                      relative overflow-hidden p-10 xl:p-12">
      ...
      {/* Logo */}
      <Link to="/" className="relative flex items-center gap-2.5 mb-12">
      ...
      <div className="relative mb-10">
        <h2 className="text-[42px] xl:text-[44px] font-bold text-[#F4F4F5]
        ...
        <p className="text-[14px] text-[#A1A1AA] mt-5 max-w-[380px] leading-relaxed">
      ...
      <div className="relative bg-[#13131A]/80 backdrop-blur-sm border border-[#1F1F26]
        ...
        <div className="flex items-baseline gap-2">
          ...
          <span className="text-[10px] text-[#4ADE80] bg-[#4ADE80]/10 px-1.5 py-0.5 rounded font-semibold">
            +12,5%
          </span>
        </div>
      ...
      <div className="relative flex items-start gap-3 mt-6 pt-6 border-t border-[#1F1F26]">
        ...
        <div>
          ...
          <div className="text-[11px] text-[#71717A] mt-0.5 leading-relaxed">
            Utilizamos criptografia de ponta<br />
            a ponta para manter suas<br />
            informações seguras.
          </div>
        </div>
      </div>
